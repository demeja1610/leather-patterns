...
class VPomoshKozhevnikuPatternAdapter extends AbstractPatternAdapter
{
    public function processPattern(Pattern $pattern): void
    {
        ...
        $postImage = $xpath->query("//*[contains(@class, 'blog-post-image')]//img");
        ...
        $downloadLinkElements = $xpath->query("//*[contains(@class, 'blog-post-body')]//a[contains(text(), 'Скачать')]");
        ...
        try {
            ...
            if ($videosToCreate !== []) {
                ...
                $this->info("Created $videosToCreateCount videos for pattern {$pattern->id}");
