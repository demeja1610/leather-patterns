...
class CutmeSourceAdapter extends AbstractSourceAdapter
{
    ...
    public function processSource(string $baseURL): void
    {
        ...
        $url = trim(string: $baseURL, characters: '/') . '/product-category/vykrojki';
        ...
        while ($page !== null) {
            ...
            $patternLinks = $xpath->query(expression: "//*[contains(@class, 'product-info-wrap')]//a[contains(@class, 'woocommerce-loop-product__link')]");
            ...
            foreach ($patternLinks as $patternLink) {
                if ($patternLink instanceof DOMElement) {
                    $patterns[] = $this->preparePatternForCreation(
                        ...
                        source: PatternSourceEnum::CUTME,
                    );
                }
            }
