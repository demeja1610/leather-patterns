...
class LeatherPatternsSourceAdapter extends AbstractSourceAdapter
{
    ...
    public function processSource(string $baseURL): void
    {
        ...
        while ($page !== null) {
            ...
            $patternsElements = $xpath->query("//*[contains(@class, 'post-card--grid')]");
            ...
            foreach ($patternsElements as $patternsElement) {
                ...
                if ($patternLink instanceof DOMElement) {
                    $patternCategory = $xpath->query(".//span[contains(@class, 'post-card__category')]", $patternsElement)->item(0);
                    ...
                    $patterns[] = $this->preparePatternForCreation(
                        ...
                        source: PatternSourceEnum::LEATHER_PATTERNS,
