...
class NeovimaSourceAdapter extends AbstractSourceAdapter
{
    ...
    public function processSource(string $baseURL): void
    {
        ...
        $url = trim(string: $baseURL, characters: '/') . '/patterns';
        ...
        while ($page !== null) {
            ...
            $patternLinks = $xpath->query(expression: "//a[contains(@class, 'woocommerce-loop-product__link')]");
            ...
            foreach ($patternLinks as $patternLink) {
                if ($patternLink instanceof DOMElement) {
                    $patterns[] = $this->preparePatternForCreation(
                        ...
                        source: PatternSourceEnum::NEOVIMA,
                    );
                }
            }
