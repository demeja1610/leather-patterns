...
class FormulaKozhiSourceAdapter extends AbstractSourceAdapter
{
    ...
    public function processSource(string $baseURL): void
    {
        ...
        while ($page !== null) {
            ...
            $patternLinks = $xpath->query(expression: "//*[contains(@class, 'entry-readmore')]//a");
            ...
            foreach ($patternLinks as $patternLink) {
                if ($patternLink instanceof DOMElement) {
                    $patterns[] = $this->preparePatternForCreation(
                        ...
                        source: PatternSourceEnum::FORMULA_KOZHI,
                    );
                }
            }
