...
class NeovimaSourceParser extends PatternSourceParser implements PatternSourceParserInterface
{
    private readonly PatternSourceEnum $patternSource;

    public function __construct(ParserServiceInterface $parserService)
    {
        $this->patternSource = PatternSourceEnum::NEOVIMA;
    ...
    public function processSource(): void
    {
        ...
        while ($page !== null) {
            ...
            $patternsElements = $xpath->query("//a[contains(@class, 'woocommerce-loop-product__link')]");
