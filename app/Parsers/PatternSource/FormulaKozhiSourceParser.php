...
class FormulaKozhiSourceParser extends PatternSourceParser implements PatternSourceParserInterface
{
    private readonly PatternSourceEnum $patternSource;

    public function __construct(ParserServiceInterface $parserService)
    {
        $this->patternSource = PatternSourceEnum::FORMULA_KOZHI;
    ...
    public function processSource(): void
    {
        ...
        while ($page !== null) {
            ...
            $patternsElements = $xpath->query("//*[contains(@class, 'entry-readmore')]//a");
