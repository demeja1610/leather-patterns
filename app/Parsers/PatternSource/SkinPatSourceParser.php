...
class SkinPatSourceParser extends PatternSourceParser implements PatternSourceParserInterface
{
    private readonly PatternSourceEnum $patternSource;

    public function __construct(ParserServiceInterface $parserService)
    {
        $this->patternSource = PatternSourceEnum::SKINPAT;
    ...
    public function processSource(): void
    {
        ...
        while ($page !== null) {
            ...
            $patternsElements = $xpath->query("//h4[contains(@class, 'pt-cv-title')]//a");
