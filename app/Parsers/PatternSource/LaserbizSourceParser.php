...
class LaserbizSourceParser extends PatternSourceParser implements PatternSourceParserInterface
{
    private readonly PatternSourceEnum $patternSource;

    public function __construct(ParserServiceInterface $parserService)
    {
        $this->patternSource = PatternSourceEnum::LASERBIZ;
    ...
    public function processSource(): void
    {
        ...
        while ($page !== null) {
            ...
            $patternsElements = $xpath->query("//div[contains(@class, 'short-items')]//div[contains(@class, 'short-item')]//a");
            ...
            $nextPage = $xpath->query(expression: "//div[contains(@class, 'nav-load')]//a");
