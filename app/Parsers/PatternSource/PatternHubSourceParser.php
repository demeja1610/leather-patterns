...
class PatternHubSourceParser extends PatternSourceParser implements PatternSourceParserInterface
{
    private readonly PatternSourceEnum $patternSource;

    public function __construct(ParserServiceInterface $parserService)
    {
        $this->patternSource = PatternSourceEnum::PATTERN_HUB;
    ...
    public function processSource(): void
    {
        ...
        while ($page !== null) {
            ...
            $patternsElements = $xpath->query("//*[contains(@class, 'wp-block-post-featured-image')]//a");
