...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_import' => [
            'driver' => 'mysql',
            'url' => env(key: 'DB_URL_IMPORT'),
            'host' => env(key: 'DB_HOST_IMPORT', default: '127.0.0.1'),
            'port' => env(key: 'DB_PORT_IMPORT', default: '3306'),
            'database' => env(key: 'DB_DATABASE_IMPORT', default: 'laravel'),
            'username' => env(key: 'DB_USERNAME_IMPORT', default: 'root'),
            'password' => env(key: 'DB_PASSWORD_IMPORT', default: ''),
            'unix_socket' => env(key: 'DB_SOCKET_IMPORT', default: ''),
            'charset' => env(key: 'DB_CHARSET_IMPORT', default: 'utf8mb4'),
            'collation' => env(key: 'DB_COLLATION_IMPORT', default: 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
