@extends('layouts.admin.list', [
    ...
    'filterUrl' => route('admin.page.pattern-tags.list'),
    'resetUrl' => route('admin.page.pattern-tags.list'),
])
                    ...
                    @foreach ($tags as $tag)
                        <x-table.tr>
                            <x-table.td-actions>
                                ...
                                <x-link.button-ghost :href="route('admin.page.pattern-tags.edit', ['id' => $tag->id])">
                            ...
                            <x-table.td>
                                <x-link.default
                                    :href="route('admin.page.pattern-tags.list', ['replace_to_tag_id' => $tag->id])"
                                    target="_blank"
                                >
                            ...
                            <x-table.td>
                                <x-link.default
                                    :href="route('admin.page.pattern-categories.list', ['replace_to_tag_id' => $tag->id])"
                                    target="_blank"
                                >
                            ...
                            <x-table.td>
                                @if ($tag->replacement)
                                    <x-link.default
                                        :href="route('admin.page.pattern-tags.list', ['id' => $tag->replacement->id])"
                                        target="_blank"
                                    >
                            ...
                            <x-table.td>
                                @if ($tag->authorReplacement)
                                    <x-link.default
                                        :href="route('admin.page.pattern-authors.list', ['id' => $tag->authorReplacement->id])"
                                        target="_blank"
                                    >
                            ...
                            <x-table.td>
                                @if ($tag->categoryReplacement)
                                    <x-link.default
                                        :href="route('admin.page.pattern-categories.list', ['id' => $tag->categoryReplacement->id])"
                                        target="_blank"
                                    >
