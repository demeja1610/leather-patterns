...
@section('header-content')
    <x-link.button-default :href="route('admin.pattern-author.create')">
...
@section('page-filters')
    ...
    <x-select.wrapper>
        <x-select.label for="has_patterns">
            {{ __('pattern_author.has_patterns') }}
        </x-select.label>

        <x-select.select
            name="has_patterns"
            id="has_patterns"
            :title="__('pattern_author.has_patterns')"
        >
            <x-select.option
                value=""
    ...
    <x-select.wrapper>
        <x-select.label for="has_replacement">
            {{ __('pattern_author.has_replacement') }}
        </x-select.label>

        <x-select.select
            name="has_replacement"
            id="has_replacement"
            :title="__('pattern_author.has_replacement')"
        >
            <x-select.option
                value=""
    ...
    <x-select.wrapper>
        ...
        <x-select.select
            ...
            id="remove_on_appear"
            :title="__('pattern_author.remove_on_appear')"
        >
            <x-select.option
                value=""
            ...
            <x-table.table>
                ...
                <x-slot:rows>
                    @foreach ($authors as $author)
                        <x-table.tr>
                            <x-table.td-actions>
                                @if ($author->isDeletable() === true)
                                    <x-link.button-default
                                        :href="route('admin.pattern-author.delete', ['id' => $author->id])"
